...
/**
 * Lawyer of One - Dynamic Agent Orchestrator
 * 
 * Template for creating orchestrators for other "Of One" sites.
 * Replace Lawyer of One, Small business owners without in-house legal counsel, and customize TASK_REGISTRY.
 */
...
const SITE_CONFIG = {
  name: 'Lawyer of One',  // e.g., 'Director of One'
  domain: 'lawyerofone.ai',   // e.g., 'directorofone.ai'
  targetAudience: 'Small business owners without in-house legal counsel', // e.g., 'one-person department managers'
  primaryColor: '#4169E1',  // Utlyze blue (keep consistent)
  accentColor: '#34495E',  // Customize per site type
};
...
const TASK_REGISTRY = {
  ...
  'content-strategy': {
    ...
    estimatedHours: 4,
    priority: 'CRITICAL',
    prompt: `Create content for ${SITE_CONFIG.name}. Target: ${SITE_CONFIG.targetAudience}. Pain points: Legal headaches keeping you up at night, Every contract falls on your desk, Fear of missing fine print, Costly legal bills for simple questions. Solution: AI-powered legal assistant with human attorney oversight. Focus on Contract review and analysis, Plain-English legal explanations, Compliance reminders, Attorney oversight for accuracy.`,
